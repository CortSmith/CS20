...
//        myTree->insert(5);
    ...
    //
    //Print the tree
    cout << endl << "Your Tree printed in post order" << endl;
    ...
    cout << endl << "Finding node with value 99" << endl;
    if (myTree->searchNode(99)) {
    ...
    cout << endl << "Finding node with value 6" << endl;
