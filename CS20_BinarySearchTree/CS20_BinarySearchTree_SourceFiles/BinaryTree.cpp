...
int BinaryTree::calculateBalance(TreeNode* rootNode) {
	...
	int a = calculateBalance(rootNode->Left) + 1;

	int b = calculateBalance(rootNode->Right) + 1;
...
int BinaryTree::calculateHeight(TreeNode* rootNode) {
	...
	int a = calculateHeight(rootNode->Left) + 1;

	int b = calculateHeight(rootNode->Right) + 1;
...
int BinaryTree::getLargestBF(TreeNode* rootNode) {
	...
	int lbf = calculateBalance(rootNode->Left) - calculateBalance(rootNode->Right);
