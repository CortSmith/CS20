...
public:
	...
	inline Customer(const Customer &obj): ID(obj.ID), Name(obj.Name), Address(obj.Address), City(obj.City), State(obj.State), ZipCode(obj.ZipCode),  AccountBalance(obj.AccountBalance) { }
	inline ~Customer() { }
